/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31a9ae6bca7213c6b36155e2eec46969)
...
interface __BaseEnv_Env {
	...
	US_FETCH: DurableObjectNamespace<import("./src/index").UsFetcher>;
	CHECK_WORKFLOW: Workflow<Parameters<import("./src/index").CheckWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UsFetcher";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "DEV_USER_EMAIL">> {}
}
